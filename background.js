document.addEventListener('DOMContentLoaded', () => {
    const games = {
        'quake': [
            ...
            { img: '../media/images/backgrounds/background1.jpg' },
            { img: '../media/images/backgrounds/background3.jpg' }
        ],
        'tactical': [
            { img: '../media/images/backgrounds/background5.jpg' },
            { img: '../media/images/backgrounds/background6.jpg' },
            { img: '../media/images/backgrounds/background7.jpg' },
            { img: '../media/images/backgrounds/background8.jpg' }
        ],
        'adel': [
            { img: '../media/images/backgrounds/background9.png' }
        ],
    };
